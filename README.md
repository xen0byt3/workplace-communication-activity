...
### DEFINITIONS
- **down** - a system not working or offline 
    > "Server is _down_"
- **ping** - contact someone 
    > "_ping_ the infra team"
- **sandbox** - a safe test environment to try out new features
    > "Only _sandbox_ shows the issue" 
- **prod** - short for production
    > "this is not affecting _prod_?"
- **hotfix** - a quick update to fix an issue
    > "I’ve written a _hotfix_ and pushed it"
- **patch** - a small software update
    > "We’ll apply the _patch_ to the live server"  
- **backdoor** - a hidden method to access the system
    > "I found traces of a _backdoor_"
- **legacy** - an old system or code still in use
    > "That panel is a _legacy_ module"
